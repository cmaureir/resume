...
\cvcomputer     {System Administration}{Apache, PHP, Software Configuration Management (Git, SVN), DBA (postgreSQL, MySQL)}
                {Web Development}{PHP, CSS, HTML}

\section{Events attendance}
\cventry{2011}{First Argentine GPGPU Computing School for Scientific Applications}{Facultad de Matemáticas, Astronomía y Física}{Universidad Nacional de Córdoba, Argentina}{http://www.famaf.unc.edu.ar/grupos/GPGPU/EscuelaGPGPU2011/}{}
...
\cventry{2010}{PASI}{Pan-American Advanced Studies Institute}{Scientific Computing in the Americas: the challenge of massive parallelism}{UTFSM, Valparaiso, Chile}{http://www.bu.edu/pasi/}
...
\cventry{2009}{XVIII Feria de Software}{Presentation of $\mu$Bot Interface project}{UTFSM}{Valparaiso}{http://vortexlabs.cl}
