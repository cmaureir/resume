...
\cvcomputer{\cc{Main Languages}}{C/C++, Python, CUDA, Shell}
           {\cc{Secondary Languages}}{Java, Fortan, Matlab/Octave, R}
\cvcomputer{\cc{Parallel Computing}}{Thrust, MPI, OpenMP, POSIX threads}
           {\cc{Libraries}}{ZeroMQ, cuBLAS, SciPy, Intel MKL}
\cvcomputer{\cc{SysAdmin}}{LAMP, Git, SVN}
           {\cc{WebDev}}{PHP, CSS, HTML, JavaScript, SQL, Jekyll}
