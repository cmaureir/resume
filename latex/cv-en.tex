...
\usepackage{fancyhdr}
\pagestyle{fancy}
\lfoot{Cristián Maureira-Fredes | \cc{2018}}

% Commands
\newcommand{\myname}{\textbf{Cristián Maureira}}
\newcommand{\myeman}{\textbf{Maureira, Cristián}}
...
\definecolor{mred}{RGB}{225,67,46}
\definecolor{mblue}{RGB}{75,92,105}
\definecolor{mgreen}{RGB}{121,189,154}
\definecolor{mcyan}{RGB}{70,197,218}
\definecolor{mwhite}{RGB}{221,220,215}
\definecolor{mgray}{RGB}{143,143,143}
\definecolor{mpetrol}{RGB}{59,134,134}
\definecolor{mnight}{RGB}{0,180,204}

\newcommand{\mred}{\textcolor{mred}}
\newcommand{\mblue}{\textcolor{mblue}}
\newcommand{\mgreen}{\textcolor{mgreen}}
\newcommand{\mcyan}{\textcolor{mcyan}}
\newcommand{\mwhite}{\textcolor{mwhite}}
\newcommand{\mgray}{\textcolor{mgray}}
\newcommand{\mpetrol}{\textcolor{mpetrol}}
\newcommand{\mnight}{\textcolor{mnight}}
...
\extrainfo{
\includegraphics[width=0.023\textwidth]{icon/Linkedin.pdf}\
\href{https://www.linkedin.com/in/cmaureir}{Cristián Maureira Fredes}\\
\includegraphics[width=0.023\textwidth]{icon/GitLab_Logo.pdf}\
\href{http://gitlab.com/u/cmaureir}{https://gitlab.com/cmaureir}\\
\includegraphics[width=0.023\textwidth]{icon/GitHub_Logo.pdf}\
\href{http://github.com/cmaureir}{https://github.com/cmaureir}}
%\photo[82pt]{photo/me}
...
\cventry{Sept 2013 to June 2018}
        {Doctoral studies}
...
\cventry{2011}{Professional Internship}
        {{\utfsm}}
        {Center for Technological Innovation in High Performance Computing (CTI-HPC)}
        {Working on the implementation of a gravitational $N$-body simulations,
...
\cventry{2010}{Professional Internship}
        ...
        {Working on the implementation of an alternative to the ALMA Common
         Software (ACS) Notification Channel using OpenDDS, \myurl{http://www.opendds.org/}}
        {UTFSM, Chile}
        {\myurl{http://csrg.cl}}
...
\cventry{2009}{Professional Internship}
        ...
        {\myurl{http://www.almaobservatory.cl}}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Computer Science Skills
\section{\LARGE Computer Science skills}
\cvcomputer{\cc{Main Languages}}{C/C++, Python, Bash}
           {\cc{Secondary Languages}}{Fortran, Java, Octave/Matlab, R}
\cvcomputer{\cc{Parallel Computing}}{CUDA, OpenMPI, OpenMP, POSIX threads}
           {\cc{Libraries}}{SciPy, Pandas, Jupyter, ZeroMQ, cuBLAS, Intel MKL, Cython, Boost, SWIG}
%\cvcomputer{Operating Systems}{Linux Distributions and Windows}
\cvcomputer{\cc{SysAdmin}}{LAMP, Git, SVN, Jenkins}
           {\cc{WebDev}}{PHP, CSS, HTML, JavaScript, MySQL, Jekyll}
\cvcomputer{\cc{Scripting}}{Python, Bash, awk, sed}
           {\cc{Data bases}}{MySQL, PostgreSQL, MongoDB}
\cvcomputer{\cc{\textbf{Learning}}}{Scala, Go, AWS, Haskell}
           {}{}
           % Feature-driven development
           % Scrum
           % Kanban
%\cvcomputer{\cc{Methods}}{Agile development (FDD, Scrum, XP)}
%           {\cc{Practices}}{Continuous integration (CI)}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Languages
\section{\LARGE Languages}
\cvlanguage{\cc{Spanish}}{Native}{-}
\cvlanguage{\cc{English}}{Fluent}{Speaks, Reads, Writes, Technical and Colloquial}
\cvlanguage{\cc{German}}{Waystage or elementary (A2)}{Speaks, Reads, Writes}
\cvlanguage{\cc{Catalan}}{Competent (A1)}{Speaks, Reads, Writes}

\section{\LARGE Events attendance}
\cventry{2018}
        {Qt World Summit}
        {Mastering Qt for Python in 20 minutes.}
        {}
        {29-30 October (Boston, US) and 5-6 December (Berlin, DE)}
        {\myurl{https://www.qtworldsummit.com/2018/berlin/}}
        {}
\cventry{2016}
...
\section{\LARGE Honour and Awards}
\cvlistitem{Master studies scholarship in Chile (2012) given by the %
            ...
            participation in academic research projects (\myurl{www.conicyt.cl}).}
\vspace{0.2cm}
\cvlistitem{Initiation in Scientific Research Scholarship (PIIC) given by %
            ...
            studies. (\myurl{http://www.dgip.utfsm.cl/})}
\vspace{0.2cm}
\cvlistitem{Master studies scholarship, financial help,
            and 100\% fee payment exemption due to good academic performance.
            ``Dirección General de Investigación y Postgrado UTFSM''
            (\myurl{http://www.dgip.utfsm.cl/})}
\vspace{0.2cm}
\cvlistitem{Be a part of the \emph{Honour List}, to the best academic %
